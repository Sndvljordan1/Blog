...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttons.ulist = makeButton("wmd-ulist-button", "Bulleted List - Ctrl+U", "glyphicon glyphicon-list", bindCommand(function (chunk, postProcessing) {
            ...
            group4 = makeGroup(4);
            buttons.undo = makeButton("wmd-undo-button", "Undo - Ctrl+Z", "glyphicon glyphicon-arrow-left", null, group4);
